...
const LocMark = ({ size = 22 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="var(--accent,#000000)" strokeWidth={2.2} strokeLinecap="round" strokeLinejoin="round">
...
const primaryBtn: React.CSSProperties = {
  ...
  borderRadius: 0,
  cursor: 'pointer',
  boxShadow: '0 10px 24px -10px rgba(0,0,0,.8)',
  display: 'flex',
  alignItems: 'center',
    ...
    <div style={authRootStyle}>
      ...
      {screen === 'splash' && (
        ...
        >
          ...
          <div style={{ animation: 'lok-pop-lg .6s cubic-bezier(.2,.9,.3,1.2) both', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div style={{ width: 96, height: 96, borderRadius: 0, background: '#F5F1E8', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 20px 50px -18px rgba(0,0,0,.5)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ height: '100%', display: 'flex', animation: 'lok-fade .5s ease both' }}>
        ...
        <div
          ...
          style={{ width: '44%', flex: 'none', background: 'var(--accent,#000000)', color: '#EAF0F8', padding: '34px 46px 30px', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, position: 'relative' }}>
            <div style={{ width: 44, height: 44, borderRadius: 0, background: '#F5F1E8', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
